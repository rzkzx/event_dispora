          ...
          <div class="sidebar">
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col">
                  <p><?= $data['riwayat']->jenis_kelamin ?></p>
                </div>
              </div>
              <div class="row">
                <div class="col">
              ...
              <div class="row">
                ...
                <div class="col">
                  <p><?= dateID($data['riwayat']->tanggal_lahir) ?></p>
                </div>
              </div>
              <div class="row">
                <div class="col">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  ...
                  if ($data['riwayat']->upload_identitas) {
                    echo '<a href="' . URLROOT . '/assets/file/identitas/' . $data['riwayat']->upload_identitas . '">' . $data['riwayat']->upload_identitas . '</a>';
                  } else {
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  ...
                  if ($data['riwayat']->berkas_syarat) {
                    echo '<a href="' . URLROOT . '/assets/file/syarat/' . $data['riwayat']->berkas_syarat . '">' . $data['riwayat']->berkas_syarat . '</a>';
                  } else {
              ...
              <div class="row ">
                ...
                <div class="col">
                  <?php
                  if ($data['riwayat']->status == 'menunggu') {
                    $badge = 'warning';
                  } elseif ($data['riwayat']->status == 'diterima') {
                    $badge = 'success';
                  } else {
                    $badge = 'danger';
                  }
                  ?>
                  <span class="badge rounded-pill bg-<?= $badge ?> text-dark text-uppercase"><?= $data['riwayat']->status ?></span>
                </div>
              </div>
              <div class="mt-4">
                <?php
                if ($data['event']->aktif) {
                  echo '<a href="' . URLROOT . '/riwayat/detail/' . $data['event']->id . '/edit" class="btn btn-warning">Edit Data Pendaftaran</a>';
                }
                ?>
              </div>
            </div>
